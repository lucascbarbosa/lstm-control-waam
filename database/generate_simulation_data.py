...
inputs_train.to_csv(data_dir + f"simulation/inputs_train.csv", index=False)
inputs_test.to_csv(data_dir + f"simulation/inputs_test.csv", index=False)
outputs_train.to_csv(data_dir + f"simulation/outputs_train.csv", index=False)
outputs_test.to_csv(data_dir + f"simulation/outputs_test.csv", index=False)
