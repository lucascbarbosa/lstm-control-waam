...
class MPC:
    def __init__(self, bead_idx):
        ...
        self.metrics_gradient = pd.read_csv(
            self.results_dir + f"models/gradient/hp_metrics.csv")
    ...
    def load_experiment(self, idxs_train, idxs_test):
        ...
        for idx_train in idxs_train:
            ...
            input_train = pd.read_csv(
                self.data_dir + filename_train + "_wfs.csv").to_numpy()
        ...
        for idx_test in idxs_test:
            ...
            input_test = pd.read_csv(
                self.data_dir + filename_test + "_wfs.csv").to_numpy()
            output_test = pd.read_csv(
                self.data_dir + filename_test + "_w.csv").to_numpy()
    ...
    def load_mpc(self):
        input_train = pd.read_csv(
            self.data_dir + "mpc/input_train.csv").to_numpy()
        output_train = pd.read_csv(
            self.data_dir + "mpc/output_train.csv").to_numpy()
        input_test = pd.read_csv(
            self.data_dir + "mpc/input_test.csv").to_numpy()
        output_test = pd.read_csv(
            self.data_dir + "mpc/output_test.csv").to_numpy()
    ...
    def export_gradient(self):
        np.savetxt(self.results_dir + "predictions/gradient/gradient_reals.csv",
                   np.array(self.gradient_reals))
        np.savetxt(self.results_dir + "predictions/gradient/gradient_preds.csv",
